...
def run(
    ...
    kept_schedules_per_quasi_stabilisers: int = 15,
    verbose: bool = False,
    ...
    # Output
    if out is None:
        out_name = f"colour_square_superdense_d{distance}_dropQ{n_dropped_qubits}_dropE{n_dropped_couplers}_L{L_found}_R{rounds}.stim"
